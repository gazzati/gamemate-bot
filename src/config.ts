...
export default {
  ...
  topics: ["Страны", "Столицы", "Певицы", "Бренды наушников", "Марки машин", "Вузы Москвы", "Российские фильмы", "Национальные блюда", "Семейство кошачьих", "Профессии", "Валюты", "Банки России", "Фрукты и ягоды", "Птицы", "Виды спорта", "Президенты стран", null]
}
